...
void negativeRedQuals(vex::task& lbResetTask, vex::task& colorSortTask, Odometry& odometry, MotorGroup& intakeMotors, MotorGroup& lbMotors, WallStakeMech& ladyBrown, Motion& motion) {
        odometry.setPos(0, 0);
    ...
    // motion.moveDist(0.75, 1, 700);
    // motion.turnHeading(145, 2, 0, 1, 400);
    // motion.moveDist(1.85, 1, 1200);
    // motion.turnHeading(-135, 2, 0, 1, 1000);
    // motion.moveDist2(2, 1, 1000);
    // motion.moveDist2(1.15, 0.4, 1200);
    // motion.moveDist(-1, 1, 1200);
    //     intakeLift = true;
    // motion.moveDist2(1.15, 0.4, 1200);
    // motion.moveDist(-1.6, 1, 1200);
    //     doinker = true;
    ...
    // //motion.moveDist(2.8, 1, 2000);
    // //motion.moveDist(2.8, 0.6, 1500);
    // motion.moveDist(3.3, 1, 2000);
    //     wait(500, vex::msec);
    //     ladyBrown.setResetSetpoint(1550);
    // motion.turnHeading(20, 2, 0, 1, 800);
    // motion.moveDist(1.2, 0.55, 10000);
    // //motion.turnHeading(-34, 2, 0, 1, 1200);
    // //motion.moveDist(2.2, 0.55, 10000);
    //     lbResetTask.suspend();
}