...
void soloAWPBlue(vex::task& lbResetTask, vex::task& colorSortTask, vex::task& colorStopTask, Odometry& odometry, MotorGroup& intakeMotors, MotorGroup& lbMotors, WallStakeMech& ladyBrown, Motion& motion);